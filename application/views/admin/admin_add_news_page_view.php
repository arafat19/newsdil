                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        <?php }
                                        if ($this->session->flashdata('page_update_message')) { ?>
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    <div class="alert alert-success" role="alert">
                                                        <i class="fa fa-check"></i>
                                                        <a href="#" class="close" data-dismiss="alert"
                                                           aria-label="close">&times;</a>
                                                        <?php echo $this->session->flashdata('page_update_message'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control" name="news_title"
                                                        id="news_title" title="Select News Title" required
                                                        autofocus>
                                                    <option selected>Please Select a News Title</option>
                                                    <?php if (isset($news_title_list) && $news_title_list->num_rows() > 0):
                                                        foreach ($news_title_list->result() as $row): ?>
                                                            <option
                                                                value="<?php echo $row->id; ?>"><?php echo $row->news_title; ?></option>
                                                            <?php
                                                        endforeach;
                                                    endif; ?>
                                                </select>
                                        ...
                                        <?php foreach ($all_news->result() as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a class="btn btn-success" title="Edit"
                                                                      href="<?php echo base_url(); ?>admin/update/news/page/<?php echo base64_encode($row->id); ?>"
                                                                      role="button"><span
