        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-users"></i> <a href="<?php echo base_url(); ?>admin/add/partners">Add Partner</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="panel panel-info">
                    ...
                    <?php echo form_open_multipart('admin/upload/partner/photo/'.$partner_id, "class='form-horizontal form-widgets'");?>
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    if ($this->session->flashdata('upload_success')) {
                                        ...
                                        <?php } ?>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="userfile">Partner Photo:</label>
                            ...
                            <div class="col-md-4">
                              <img class="img-circle" height="145px" width="145px" src="<?php echo base_url() ;?>uploaded/partners/<?php echo $single_partner['partner_image'] ? $single_partner['partner_image'] : 'blank_person.png'; ?>" alt="<?php echo $single_partner['partner_image']; ?>" />
                            </div>
                        </div>
                    </div>
