                ...
                <div class="panel panel-info">
                    ...
                    <form name='update_project_cat_form' id='update_project_cat_form' enctype="multipart/form-data"
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="project_cat_name" onblur="test()"
                                                       id="project_cat_name"  value="<?php echo $single_project_cat['project_category_name']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="project_cat_code"
                                                       id="project_cat_code" placeholder="Project Category Code" value="<?php echo $single_project_cat['project_category_code']; ?>"
                                                       required/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="checkbox">
                                                    <input type="checkbox" id="is_active"
                                                           name="is_active" value="1" <?php echo ($single_project_cat['is_active']== 1 ? 'checked' : '');?> />
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                        ...
                        <div class="panel-footer panel-success">
                            ...
                            <a class="btn btn-danger" href="<?php echo base_url();?>admin/add/project/category/" role="button"><span class="glyphicon glyphicon-remove"></span>Cancel</a>
                        </div>
                    </form>
                </div>
                <!-- /.row -->
