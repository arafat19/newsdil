        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-users"></i> <a href="<?php echo base_url(); ?>admin/add/news">Add News</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="panel panel-info">
                    ...
                    <?php echo form_open_multipart('admin/upload/news/photo/'.$news_id, "class='form-horizontal form-widgets'");?>
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-md-8">
                                <fieldset>
                                    ...
                                    if ($this->session->flashdata('upload_success')) {
                                        ...
                                        <?php } ?>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="userfile">News Image:</label>
                            ...
                            <div class="col-md-4">
                              <img class="img-responsive img-thumbnail" height="145px" width="145px" src="<?php echo base_url() ;?>uploaded/news_image/<?php echo $single_news['news_image'] ? $single_news['news_image'] : 'default_news.jpg'; ?>" alt="<?php echo $single_news['news_image']; ?>" />
                            </div>
                        </div>
                    </div>
