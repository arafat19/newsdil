        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="panel panel-info">
                    ...
                    <?php echo form_open_multipart('admin/uploadfav', "class='form-horizontal form-widgets'");?>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <img src="<?php echo base_url() ;?>uploaded/admin/<?php echo $all_system_configuration['favicon']; ?>" alt="<?php echo $all_system_configuration['favicon']; ?>" />
                            </div>
                        </div>
                    </div>
