                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <div class="block-iteam">
                            ...
                            <div class="twitt-list"> <i class="fa fa-twitter"></i>
                                <p>Check out 'Chow - <span>Recipe & Food WordPress Theme' on #EnvatoMarket #themeforest http://t.co/OKLOuekjcW </span>109 days ago</p>
                            </div>
                            <div class="twitt-list"> <i class="fa fa-twitter"></i>
                                <p> Check out this great #themeforest item 'Trizzy - Multi-Purpose WooCommerce WordPress Theme'<span> http://t.co/gEvxLFuwB4</span> 302 days ago</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
