...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = "/$software_directory/uploads/content-images"; // Relative to domain name
	$config['upload_path'] = '../../../../uploads/content-images'; // Physical path. [Usually works fine like this]
